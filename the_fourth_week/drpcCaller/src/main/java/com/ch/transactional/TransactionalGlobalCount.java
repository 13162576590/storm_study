...
public class TransactionalGlobalCount {
	...
	public static class BatchCount extends BaseBatchBolt {
		...
		public void prepare(Map conf, TopologyContext context, BatchOutputCollector collector, Object id) {
			System.out.println("*************BatchCount***************prepare************");
		...
		public void execute(Tuple tuple) {
			System.out.println("*************BatchCount***************execute************");
		...
		public void finishBatch() {
			System.out.println("*************BatchCount***************finishBatch************");
		...
		public void declareOutputFields(OutputFieldsDeclarer declarer) {
			System.out.println("*************BatchCount***************declareOutputFields************");
	...
	public static class UpdateGlobalCount extends BaseTransactionalBolt implements ICommitter {
		...
		public void prepare(Map conf, TopologyContext context, BatchOutputCollector collector,
			...
			System.out.println("*************UpdateGlobalCount***************prepare************");
		...
		@Override
		public void execute(Tuple tuple) {
			System.out.println("*************UpdateGlobalCount***************execute************");
		...
		@Override
		public void finishBatch() {
			System.out.println("*************UpdateGlobalCount***************finishBatch************");
			...
			System.out.println();
			System.out.println("the sum of the counts are:" + _attempt + " : " + newval.count);
			System.out.println();
		}

		@Override
		public void declareOutputFields(OutputFieldsDeclarer declarer) {
			System.out.println("*************UpdateGlobalCount***************declareOutputFields************");
